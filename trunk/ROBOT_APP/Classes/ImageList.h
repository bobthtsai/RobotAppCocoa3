...
#define IMAGELIST_UPDATE_TIME_NUMBER "Image//JW_M_sk_bo_n3.png" //數字自行

//指定載入圖檔 (日後可能要加入不同解析度的)
...
static const int STR_CLEANJOB_SIZE_M	= 20;
...
static const int STR_STATE_SIZE_M   = 27;
...
static const int STR_CLEAN_LABSIZE_M   = 16;
...
static const int STR_LATER_SIZE_M = 12;
static const int STR_LATER_SIZE_H = 19;
static const int STR_LATER_SIZE_XH = 26;
static const int STR_LATER_SIZE_XXH = 33;

//常用顏色定義
static const ccColor3B COLOR_STRING_WHITE=ccc3(254,254,254);
static const ccColor3B COLOR_STRING_ORIGIN=ccc3(255,255,255);

static const ccColor3B COLOR_STRING_GREEN=ccc3(BTN_Refresh_Enable_COLOR_R,BTN_Refresh_Enable_COLOR_G,BTN_Refresh_Enable_COLOR_B);

static const ccColor3B COLOR_STRING_GREY=ccc3(BTN_Refresh_Disable_COLOR,BTN_Refresh_Disable_COLOR,BTN_Refresh_Disable_COLOR);
static const ccColor3B COLOR_STRING_LIGHTGREY=ccc3(0xF2,0xF2,0xF2);
static const ccColor3B COLOR_STRING_BLACK2=ccc3(0,0,0);
static const ccColor3B COLOR_STRING_BLACK=ccc3(STR_HELP_COLOR,STR_HELP_COLOR,STR_HELP_COLOR);
static const ccColor3B COLOR_STRING_LIGHTBLACK=ccc3(153,153,153);
static const ccColor3B COLOR_STRING_RED=ccc3(STR_ERROR2_COLOR_R,STR_ERROR2_COLOR_G,STR_ERROR2_COLOR_B);
static const ccColor3B COLOR_STRING_ERRBLACK=ccc3(STR_ERROR_COLOR_R,STR_ERROR_COLOR_G,STR_ERROR_COLOR_B);
static const ccColor3B COLOR_STRING_TITAL=ccc3(STR_TITAL_COLOR_R, STR_TITAL_COLOR_G, STR_TITAL_COLOR_B);

//切換狀態 加快圖示
void WifiSearchIcon_AddSpeed();

EXTERN const int *pSTR_CLEANJOB_SIZE;
EXTERN const int *pSTR_TITAL_SIZE;
EXTERN const int *pSTR_ERROR_SIZE;
EXTERN const int *pSTR_STATE_SIZE;
EXTERN const int *pSTR_WIFILIST_SIZE;
EXTERN const int *pSTR_ROBOTMAIN_LABSIZE;
EXTERN const int *pSTR_CLEAN_LABSIZE;
EXTERN const int *pSTR_RESERV_LABSIZE;
EXTERN const int *pSTR_HELP_SIZE;
EXTERN const int *pSTR_DATE_SIZE;
EXTERN const int *pSTR_TIME_SIZE;
EXTERN const int *pSTR_LINK_SIZE;
EXTERN const int *pSTR_SETUP_SIZE;
EXTERN const int *pSTR_BTN_SIZE;
EXTERN const int *pSTR_TOAST_SIZE;
EXTERN const int *pSTR_DIALOG_SIZE;
EXTERN const int *pSTR_LATER_SIZE;
