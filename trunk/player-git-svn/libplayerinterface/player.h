...
#define PLAYER_MAX_MESSAGE_SIZE 5242880 /*5MB*/
...
#define PLAYER_MAX_DEVICES             128
/** Default maximum length for a message queue */
#define PLAYER_MSGQUEUE_DEFAULT_MAXLEN 512
...
/** @brief A coordinate on the map */
typedef struct player_map2d
{
  /** X [pixel] */
  int px;
  /** Y [pixel] */
