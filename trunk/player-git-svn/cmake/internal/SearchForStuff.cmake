...
# Look for LibSerial
SET(LIBSERIAL_INCLUDE_DIR "" CACHE STRING "LibSerial include directory")
SET(LIBSERIAL_LIB_DIR "" CACHE STRING "LibSerial library directory")

set(CMAKE_REQUIRED_INCLUDES ${LIBSERIAL_INCLUDE_DIR})
CHECK_INCLUDE_FILE("SerialStream.h" HAVE_LIBSERIAL_H)
CHECK_LIBRARY_EXISTS (serial SerialStream "${LIBSERIAL_LIB_DIR}" HAVE_LIBSERIAL_LIB)
IF (HAVE_LIBSERIAL_H AND HAVE_LIBSERIAL_LIB)
    SET(HAVE_LIBSERIAL 1)
ENDIF(HAVE_LIBSERIAL_H AND HAVE_LIBSERIAL_LIB)
