                 ...
                 gpointer data)
{
  ...
  for(i=0;i<gui_data->num_robots;i++)
  {
    ...
    if(planner)
    {
      playerc_planner_enable(planner,0, 0);
               ...
               gpointer data)
{
  ...
  for(i=0;i<gui_data->num_robots;i++)
  {
    ...
    if(planner)
    {
      playerc_planner_enable(planner,1,0);
        ...
        case 2:
          if(onrobot && !setting_theta)
          {
            ...
            playerc_planner_enable(gui_data->planners[idx],
                                   gui_data->robot_enable_states[idx], 0);
          }
          break;
        case 3:
        ...
        case 1:
          ...
          else
          {
            ...
            if(setting_goal)
            {
              ...
              {
                //playerc_planner_enable(gui_data->planners[idx],1,1); //test explore, can show explore route on gui.
                printf("setting goal (planner) for robot %d to (%.3f, %.3f, %.3f)\n",
            ...
            else
            {
              ...
              {
                printf("setting pose (localizes) for robot %d to (%.3f, %.3f, %.3f)\n",
                       idx, mean[0], mean[1], mean[2]);
