...
color=	rgbHue(((float)(laser->proxy->intensity[i]))/255.*0.6);
      if (i == 0)
      {
        ax = bx;
        ay = by;
      }
    //rtk_fig_color_rgb32(laser->scan_fig,color);
//rtk_fig_color(laser->scan_fig,((double)i)/((double)(laser->proxy->scan_count)),((double)i)/((double)(laser->proxy->scan_count)),((double)i)/((double)(laser->proxy->scan_count)));
...
rtk_fig_color(laser->scan_fig,Huer(((float)(laser->proxy->intensity[i]))/255.*0.6),Hueg(((float)(laser->proxy->intensity[i]))/255.*0.6),Hueb(((float)(laser->proxy->intensity[i]))/255.*0.6));
